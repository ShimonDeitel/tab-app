...
struct ContentView: View {
    ...
    @State private var editingEntry: TabEntry?
    ...
    private func entryRow(_ entry: TabEntry) -> some View {
        HStack {
...
struct AddEntrySheet: View {
    ...
    init(existing: TabEntry? = nil, onSave: @escaping (String, Double) -> Void) {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(existing == nil ? "Add Round" : "Edit Round")
